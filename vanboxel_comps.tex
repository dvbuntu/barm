...
\dvb{inject motivation concepts here?}
...
\dvb{Explain general posterior for BARN here, in very little space, but combine NN optimization as part of process.  More details about $P(M)$ components? }
...
\dvb{mention why python?  also unittests, documentation, and full tutorial walkthrough with synth data}
